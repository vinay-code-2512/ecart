...
class Buyer(models.Model):
    ...
    addressline1 = models.CharField(max_length=50,default="",null=True,blank=True)
    addressline2 = models.CharField(max_length=50,default="",null=True,blank=True)
    addressline3 = models.CharField(max_length=50,default="",null=True,blank=True)
    ...
    otp = models.IntegerField(default=-12332222)
...
class Checkout(models.Model):
    ...
    rppid = models.CharField(max_length=100,default="")
